...
public class ExecReplay extends Exec
{
    ...
    public static void main(String[] args)
    {
        ...
        m_mapName = "maps/Stage10A/ptsp_map01.map";  //Set here the name of the map to play in.
        m_actionFilename = "testResults/CMA/CMA-1-m0-t0.txt"; //Indicate here the name of the file with the actions saved TO SEE a replay.
